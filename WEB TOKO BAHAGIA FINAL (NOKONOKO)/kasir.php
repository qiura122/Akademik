                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Tanggal: <?php echo $tgl_transaksi ?></li>
                           
                        </ol>
                        <h1 class="mt-1 fs-5">Kasir: <?php echo $nama_kasir ?></h1>
                        <h1 class="mt-1 fs-5">Customer: <?php echo $customer ?></h1>
                        <div class="row">
                        <div class="card mb-4">
                            ...
                            <?php
                                $discount = ($customer == 'umum') ? 0 : 0.1 * $Totalbelanja;
                                $Totalbelanja -= $discount; 
                                
                                echo "<h2 class=fs-4> Sub Total: " . ($Totalbelanja + $discount) . "</h2>";
                                echo "<h2 class=fs-4> Discount: " . $discount . "</h2>";
                                echo "<h2 class=fs-4> Total Semua: " . $Totalbelanja . "</h2>";
